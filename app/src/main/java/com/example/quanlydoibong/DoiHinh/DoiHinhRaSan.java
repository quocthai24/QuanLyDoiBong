...
public class DoiHinhRaSan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doi_hinh_ra_san);
        setControl();
        setEvent();
    }
    private void setEvent() {
        ...
        btnDoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                data_ct.clear();
                data_ct.addAll(db.DocCauThuRaSan());
        ...
        btnThem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(DoiHinhRaSan.this, TrangChuCauThu.class);
                startActivity(intent);
            }
        });
    }
    private void setControl() {
        btnDoc=findViewById(R.id.btnDocDLCauThuRaSan);
        btnThem=findViewById(R.id.btnThemCauThuRaSan);
        btnThoat=findViewById(R.id.btnThoat_CTRS);
        lvDanhSachCT = findViewById(R.id.lvDanhSachCauThuRaSan);
    }
}